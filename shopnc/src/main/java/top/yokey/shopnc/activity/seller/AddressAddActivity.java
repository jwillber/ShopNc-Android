...
public class AddressAddActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        setContentView(R.layout.activity_seller_address_add);
    ...
    private void addAddress() {
        ...
        SellerAddressModel.get().addressAdd(name, phone, cityId, areaId, address, areaInfo, isDefault, new BaseHttpListener() {
            @Override
