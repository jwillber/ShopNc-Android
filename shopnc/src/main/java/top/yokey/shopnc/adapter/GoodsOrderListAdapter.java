...
class GoodsOrderListAdapter extends RecyclerView.Adapter<GoodsOrderListAdapter.ViewHolder> {

    private final ArrayList<OrderBean.OrderListBean.ExtendOrderGoodsBean> arrayList;
    private OnItemClickListener onItemClickListener;

    GoodsOrderListAdapter(ArrayList<OrderBean.OrderListBean.ExtendOrderGoodsBean> arrayList) {
